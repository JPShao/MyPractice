...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = getContext().getResources().getColor(R.color.app_theme_color);
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = getContext().getResources().getColor(R.color.app_theme_color);
    //列表icon资源
    ...
    private void init(Context context) {
        ...
        scrollView.addView(tabs_layout);
        tabs = new ArrayList<>();
...
//        addView(line);
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.color_f5f5f5));
        addView(grayLine);
    ...
    private Tab newTab(CharSequence text, boolean isSelected) {
        ...
        tab.setPadding(SizeUtils.dp2px(16), SizeUtils.dp2px(12), 0, SizeUtils.dp2px(12));
     ...
     * 获取当前列表的数据
     */
    public ArrayList<CityInterface> getCurrentRvData() {
...
//    }
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = getContext().getResources().getColor(R.color.app_theme_color);
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            if (TextUtils.equals(tabs.get(tabIndex).getText(), cities.get(position).cityName())) {
            ...
            holder.tv.setText(cities.get(position).cityName());
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        ...
                        tabs.get(tabIndex).setText(((CityInterface) v.getTag()).cityName());
        ...
        public ArrayList<CityInterface> getData() {
            return cities;
        }
